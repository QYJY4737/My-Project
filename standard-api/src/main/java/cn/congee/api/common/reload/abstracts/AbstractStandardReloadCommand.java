 ...
 * Time: 下午12:15
 **/
public abstract class AbstractStandardReloadCommand implements StandardReloadCommandInterface {
     ...
     * Reload的执行类
     */
    private StandardReloadManager reloadManager;

    public AbstractStandardReloadCommand(StandardReloadManager reloadManager) {
