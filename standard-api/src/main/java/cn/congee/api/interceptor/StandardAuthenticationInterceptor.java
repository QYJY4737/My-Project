...
import cn.congee.api.module.system.login.LoginTokenService;
import cn.congee.api.module.system.login.LoginResponseCodeConst;
 ...
 **/
@Component
public class StandardAuthenticationInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        List<String> list = StandardStringUtil.splitConvertToList(className, "\\.");
        ...
        if (noValidPrivilege != null) {
            StandardRequestTokenUtil.setUser(request, requestToken);
            return true;
        }
        //需要验证权限
