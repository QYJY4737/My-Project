 ...
 * Time: 上午10:51
 **/
public class StandardDateUtil extends DateUtils {
    ...
    public static boolean isCurrentDayYMD(String dateStr) {
        ...
        String current = StandardDateUtil.formatYMD(new Date());
    ...
    public static boolean isCurrentMonthYMD(String dateStr) {
        ...
        String queryDate = StandardDateUtil.formatYM(StandardDateUtil.parseYMD(dateStr));
        String current = StandardDateUtil.formatYM(new Date());
    ...
    public static List<String> getiIntervalDate(String dateBegin, String dateEnd) {
        ...
        Date startDate = StandardDateUtil.parseYMD(dateBegin);
        Date endDate = StandardDateUtil.parseYMD(dateEnd);
        Calendar cal = Calendar.getInstance();
        cal.setTime(startDate);
        dateList.add(dateBegin);
        while (cal.getTime().compareTo(endDate) < 0) {
            cal.add(Calendar.DAY_OF_MONTH, 1);
            dateList.add(StandardDateUtil.formatYMD(cal.getTime()));
        }
        return dateList;
    }
