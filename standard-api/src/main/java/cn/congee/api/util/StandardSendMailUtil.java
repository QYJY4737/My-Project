 ...
 **/
@Slf4j
public class StandardSendMailUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String myEmailAccount = "1647731302@qq.com";
        String myEmailPassword = "kbzfyackyjoacdja";
        // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
        // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
        String myEmailSMTPHost = "smtp.qq.com";
        // 收件人邮箱（替换为自己知道的有效邮箱）
        String[] toMailAccountList = new String[]{"3183084220@qq.com"};
        StandardSendMailUtil.sendMail(myEmailAccount, myEmailPassword, "", toMailAccountList, "", myEmailSMTPHost, "测试发送邮件", "测试发送邮件");
