...
import cn.congee.api.module.system.datascope.service.DataScopeSqlConfigService;
...
public class MyBatisPlugin implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        List<String> methodStrList = StandardStringUtil.splitConvertToList(id, "\\.");
    ...
    public DataScopeSqlConfigService dataScopeSqlConfigService() {
        return (DataScopeSqlConfigService) StandardApplicationContext.getBean("dataScopeSqlConfigService");
    }
