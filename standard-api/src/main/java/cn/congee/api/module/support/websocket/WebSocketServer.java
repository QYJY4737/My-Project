...
import cn.congee.api.module.support.websocket.domain.MessageCommonDTO;
import cn.congee.api.module.support.websocket.domain.MessageDTO;
import cn.congee.api.module.support.websocket.domain.WebSocketHeartBeatDTO;
...
public class WebSocketServer {
    ...
    public static void sendAllOnLineUser(String message, Long fromUserId) {
        for (Map.Entry<Long, Session> entry : webSocketSession.entrySet()) {
